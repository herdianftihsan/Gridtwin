    ...
    <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-3 rounded-2xl bg-white/95 backdrop-blur-md border border-slate-200/90 shadow-sm text-left z-20">
      ...
      <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-xs">
        <div className="flex flex-col">
          <span className="text-[10px] text-slate-400 font-medium">Permintaan Bulanan</span>
        ...
        <div className="flex flex-col">
          <span className="text-[10px] text-amber-600 font-medium">Produksi Panel Surya</span>
        ...
        <div className="flex flex-col">
          <span className="text-[10px] text-indigo-600 font-medium">Penarikan Jaringan PLN</span>
        ...
        <div className="flex flex-col">
          <span className="text-[10px] text-emerald-600 font-medium">Otonomi Jaringan</span>
