...
export function BatteryNode({ telemetry, position, isSelected, onSelect }: {
  ...
  return (
    <EnergyNode
      ...
      onSelect={onSelect}
      accentColorClass="bg-teal-100 border border-teal-200 text-teal-600"
      ringColorClass="ring-teal-400/20"
      icon={
